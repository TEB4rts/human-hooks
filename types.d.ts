...
export type ReviewEventName = 'review.created' | 'review.reused' | 'review.approval_recorded' | 'review.approved' | 'review.rejected' | 'review.expired' | 'review.executed';
...
export type Condition<TPayload extends JsonMap = JsonMap, TMeta extends JsonMap = JsonMap> = (context: PolicyContext<TPayload, TMeta>) => boolean | Promise<boolean>;
